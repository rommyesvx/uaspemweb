...
<body>
	<div class="row flex-nowrap">
		...
		<div class="col">
			<h4 class="mt-2">Form Surat Penelitian Mata Kuliah</h4>
			<form class="m-3">
				<div class="row">
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Nama Lengkap Anggota 1</label>
							<input type="text" class="form-control" placeholder="Nama Lengkap Anggota 1">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>NPM Anggota 1</label>
							<input type="text" class="form-control" placeholder="NPM Anggota 1">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Nama Lengkap Anggota 2</label>
							<input type="text" class="form-control" placeholder="Nama Lengkap Anggota 2">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Nama Lengkap Anggota 3</label>
							<input type="text" class="form-control" placeholder="Nama Lengkap Anggota 3">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Nama Lengkap Anggota 4</label>
							<input type="text" class="form-control" placeholder="Nama Lengkap Anggota 4">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
