...
$query = mysqli_query($koneksi, "SELECT matakuliah.SKS, matakuliah.NamaMataKuliah, matakuliah.IdMatakuliah
  FROM mahasiswa
  					...
  					<?php if(mysqli_num_rows($query)>0){ ?>
  						...
  						while($data = mysqli_fetch_array($query)){
  							...
  							<tr>
  								...
  								<td><a href="action/delete_krs.php?IdMataKuliah=<?php echo $idmatkul; ?>"><button type="button" class="
  									btn btn-danger btn-sm">Delete</button></a></td>
  							</tr>
  							<?php $no++; } ?>
  						<?php } ?>
  					</table>
  					<a href="tambahkrs.php"><button type="button" class="btn btn-primary">Tambah KRS</button></a>
